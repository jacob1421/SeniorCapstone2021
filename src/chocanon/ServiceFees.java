 ...
 * @author ljcla
 */
public class ServiceFees extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiceFees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
